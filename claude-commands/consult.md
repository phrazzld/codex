...
- Run architect for task generation:
    ```bash
    architect --instructions CONSULT-TASKGEN-REQUEST.md --output-dir architect_output_tasks --model gemini-2.5-pro-exp-03-25 DEVELOPMENT_PHILOSOPHY.md CONSULTANT-PLAN.md
    ```
